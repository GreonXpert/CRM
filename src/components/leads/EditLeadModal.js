...
// Styled Components (same as LeadStepper)
...
const EditLeadModal = ({ open, onClose, lead }) => {
  ...
  const getStepContent = (step) => {
    ...
    const sectionDescriptions = [
      'Update personal identification details',
      'Modify employment and income information',
      'Change preferred banking partner'
    ];
            ...
            <Box sx={{ p: 3, pt: 0 }}>
              ...
              >
                ...
                {activeStep === steps.length - 1 ? (
                  ...
                  <SaveButton onClick={handleNext} endIcon={<ArrowForward />}>
                    Continue
                  </SaveButton>
                )}
              </Paper>
